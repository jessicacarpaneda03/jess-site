...
export const publicReplies: PublicReply[] = [
  {
    ...
    answer: `Olá! Agradecemos seu contato. 🌿
...
Estamos à disposição. 💚`,
  },
  {
    ...
    answer: `Olá! Obrigada pelo interesse. 🌿

Os valores praticados pela Dra. Jéssica Carpaneda são:
...
Se quiser conversar com a doutora: https://www.doctoralia.com.br/z/FcjTe4`,
  },
  {
    ...
    answer: `Olá! Sim — esse é um dos focos principais da Dra. Jéssica Carpaneda. 🌿
...
Para agendar: https://www.doctoralia.com.br/z/FcjTe4`,
  },
  {
    ...
    answer: `Olá! O agendamento é simples e 100% online. 🌿

1. Acesse: https://www.doctoralia.com.br/z/FcjTe4
2. Escolha o tipo de consulta (primeira ou retorno)
...
Qualquer dúvida, é só responder por aqui. Estamos à disposição. 💚`,
  },
  {
    ...
    answer: `Olá! Que bom que está pensando em buscar ajuda — esse já é um passo importante. 🌿

A primeira consulta com a Dra. Jéssica dura 50 minutos e é feita por videochamada. Nela, a doutora dedica tempo para te ouvir com calma, entender seu histórico, suas queixas atuais e construir, junto com você, um plano de cuidado.
...
Para agendar uma consulta: https://www.doctoralia.com.br/z/FcjTe4`,
  },
  {
    ...
    answer: `Olá! Sim — esse é um dos principais focos do consultório. 🌿
