...
A renovação de receita exige consulta médica — é uma exigência ética e legal do CFM, não apenas do consultório. Pacientes em acompanhamento com a Dra. Jéssica podem agendar um retorno (R$ 230, 60 min) onde a medicação é reavaliada e a receita reemitida na hora.
...
Se a dúvida é urgente e você já é paciente, agende um retorno breve (R$ 230). Se ainda não é paciente, a primeira consulta (R$ 400) permite avaliar com segurança.
...
• Primeira consulta: R$ 400 (90 min) • 100% online
...
A primeira consulta com a Dra. Jéssica em {{especialidade}} dura 90 minutos e é feita por videochamada. Nela, a doutora dedica tempo para te ouvir com calma, entender seu histórico, suas queixas atuais e construir, junto com você, um plano de cuidado.
...
Pacientes com último atendimento há até 12 meses podem agendar como retorno (R$ 230). Acima desse prazo, a recomendação é nova primeira consulta (R$ 400), para a doutora reavaliar seu quadro com calma e atualizar o plano de cuidado.
